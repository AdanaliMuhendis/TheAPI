...
```sh
pip install git+https://github.com/AdanaliMuhendis/TheAPI@main
```
...
This Project is Licensed under [MIT License](https://github.com/AdanaliMuhendis/TheAPI/blob/main/LICENSE)